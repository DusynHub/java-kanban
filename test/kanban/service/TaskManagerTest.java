...
// тесты создания RegularTask
    ...
    public void shouldCreateRegularTaskInRegularTaskStorage(){
        ...
        assertEquals(regularWithId0, result);
    }
    @Test
    public void shouldCreate3RegularTasksInRegularTaskStorage(){
        ...
        RegularTask regularWithId1 = new RegularTask(
                1
                ,"1 regular"
                ,"regular with id 1"
                , StatusName.NEW
        ...
        RegularTask regularWithId2 = new RegularTask(
                2
                ,"2 regular"
                ,"regular with id 2"
                , StatusName.NEW
        ...
        taskManager.createRegularTask(regularWithId0);
        taskManager.createRegularTask(regularWithId1);
        taskManager.createRegularTask(regularWithId2);

        HashMap<Integer, Task> expected = new HashMap<>(3);
        expected.put(0, regularWithId0);
        expected.put(1, regularWithId1);
        expected.put(2, regularWithId2);
...
// тесты обновления RegularTask
    ...
    public void shouldUpgradeRegularTaskWithUpdatedStatus(){
        ...
        assertEquals(updateRegularWithId0, taskManager.getRegularTask(0));
    }
...
// тесты удаления RegularTask по id
    ...
    public void shouldReturnMessageOnDeleteIfRegularTaskStorageIsEmpty(){
        ...
        assertEquals(expected, messageIfRegularTaskToDeleteDoNotExist);
    }
    @Test
